  ...
  class CSF {
    ...
    public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
      ...
      if ( ! empty( $field_type ) ) {
        ...
        echo '<div class="csf-field csf-field-'. esc_attr($field_type . $is_pseudo . $class . $visible) .'"'. $depend .'>';

        if ( ! empty( $field['fancy_title'] ) ) {
          echo '<div class="csf-fancy-title">' . esc_html($field['fancy_title']) .'</div>';
        }
        ...
        echo ( ! empty( $field['title'] ) || ! empty( $field['fancy_title'] ) ) ? wp_kses('<div class="csf-fieldset">', array('div'=> array('class'=> array())) ) : '';
      ...
      echo ( ! empty( $field['title'] ) || ! empty( $field['fancy_title'] ) ) ? wp_kses('</div>', array('div' => array()) ) : '';
